...
//-------------------------------------------------------Load Cell----------------------------------------------------------------////
  ...
  // Using a Nema 17 stepper motor and A4988 driver to turn the water cooling flow valve.
  // Implementation of code uses AccelStepper library to move and position the motor.
